...
* Definitions
** Z-score
The difference between an observed value an expected or average value, divided
...
* Discussion points
** TODO Non-standard residues in protein, DNA, RNA chains; Carbohydrates; Ligand geometry; Other polymers
Are we interested in this too?

** TODO Some testing data
Can I generate this somehow? Do I need to create mmCIF manually?

** TODO Do we also want a database of processed data for easy retrieval?
...
** Maxit
[[https://sw-tools.rcsb.org/apps/MAXIT/][MAXIT]] assists in the processing and curation of macromolecular structure data. MAXIT can:

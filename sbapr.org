...
* Current work
** TODO Rethink architecture to allow uploading huge files
DEADLINE: <2023-12-14 Thu>
** TODO We need storage for temporary results/uploads
DEADLINE: <2023-12-14 Thu>
We don't need a DB since we don't need to do any advanced lookup.  A "bucket" of
sorts might be enough, something like Ceph or SeaweedFS?
** TODO Create a simple library client for the validate() RPC
DEADLINE: <2023-12-14 Thu>
